...
```
### Контроллер дисплея GC9A01 требует специфической инициализации для правильного отображения цветов (инверсия) и ориентации. Заходим в menuconfig и настрайваем дисплей
```bash
idf.py menuconfig
```
- Component config
